...
import './MeterA.css'; // Import CSS file
...
const Gauge = ({ title, value, maxValue }) => {
    const gradientColors = {
        startColor: "#FFD700", // Yellow
        midColor: "#FFA500",   // Orange
        endColor: "#FF4500",   // Red
    };
        ...
        <div className="gauge">
            ...
            <div className={`${title.toLowerCase()}`}>
                <ReactSpeedometer
                    maxValue={maxValue}
                    value={value}
                    segments={3} // Three segments for the gradient
                    currentValueText="" // Removed the current value display
